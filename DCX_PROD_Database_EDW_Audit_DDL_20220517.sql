...
/****** Object:  Table [dbo].[Salesforce_Event_Log]    Script Date: 5/17/2022 3:46:26 PM ******/
...
/****** Object:  Table [dbo].[Salesforce_Error_Log]    Script Date: 5/17/2022 3:46:26 PM ******/
...
/****** Object:  Table [dbo].[Process_Log]    Script Date: 5/17/2022 3:46:26 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Process_Log]') AND type in (N'U'))
DROP TABLE [dbo].[Process_Log]
GO

/****** Object:  Table [dbo].[Delta_Settings]    Script Date: 5/17/2022 3:46:26 PM ******/
